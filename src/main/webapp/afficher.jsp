...
<table class="table table-striped table-hover">
    ...
    <s:iterator value="eleves">
        <tr>
            ...
            <td><s:if test="filiere != null">
            <s:property value="filiere.nomFil"/>
            </s:if>
            <s:else>
                <s:property value="Indeterminer"/>
            </s:else></td>
            <td> <a class="btn btn-info" href="<s:url action="editAction"><s:param name="codeId"><s:property value="cne"/></s:param></s:url>" >
            Modifier
            </a>
                <a class="btn btn-danger" href="<s:url action="deletEleve"><s:param name="codeId"><s:property value="cne"/></s:param></s:url>" >
                    Supprimer
                </a>
            </td>
