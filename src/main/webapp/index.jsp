...
<table class="table table-striped table-hover">
    ...
    <s:iterator value="filieres">
        <tr>
            ...
            <td><a href="editFiliere?codeFil=<s:property value='codeFil'/>" class="btn btn-info">Modifier</a></td>
            <td><a href="deleteFiliere?codeFil=<s:property value='codeFil'/>" class="btn btn-danger">Supprimer</a></td>
        </tr>
    </s:iterator>
    </tbody>
</table>
